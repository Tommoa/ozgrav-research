...
As per the criteria laid out in section \ref{sec:design_process:criteria}, the implementation of \(N\)-detectors has largely been a success, however there are still areas for improvement.
These areas will be laid out in section \ref{sec:further_work}.
