...
reduced to \(O(\log{n}^2)\) using a sorting network, which uses a fixed set of comparisons on the
order of \(O(n\log{n}^2)\) \cite{nvidia}. By measuring the total number of comparitors, it would
